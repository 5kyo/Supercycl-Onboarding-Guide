...
const I18N = {
  ko: {
    ...
    'toc4.title': 'Signals', 'toc4.sub': '시그널 확인하기',
    'toc5.title': 'Portfolio', 'toc5.sub': '내 자산 확인',
    'toc6.title': 'Profile', 'toc6.sub': '설정 관리',
    'toc7.title': '앱 설치하기', 'toc7.sub': '홈 화면에 추가',
    ...
    'sg.li2': '위쪽 코인 칩에서 시그널을 받는 코인을 확인할 수 있습니다. 코인 목록과 이용 권한은 거래소(EX)에서 관리됩니다.',
  ...
  en: {
    ...
    'toc4.title': 'Signals', 'toc4.sub': 'Trading signals',
    'toc5.title': 'Portfolio', 'toc5.sub': 'Track your assets',
    'toc6.title': 'Profile', 'toc6.sub': 'Manage settings',
    'toc7.title': 'Install the App', 'toc7.sub': 'Add to home screen',
    ...
    'sg.li2': 'The coin chips at the top show which coins you receive signals for. Your coin list and access are managed on the exchange (EX).',

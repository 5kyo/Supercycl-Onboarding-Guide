...
const I18N = {
  ko: {
    ...
    'ob.lead': 'Supercycl을 처음 사용할 때는 아래 5단계만 따라 하면 됩니다. 5분이면 충분해요.',
    's1.title': '로그인하기',
  ...
  en: {
    ...
    'ob.lead': 'Just follow these five steps the first time you use Supercycl. It only takes about five minutes.',
    's1.title': 'Log In',
